...
public class FlyCam : MonoBehaviour
{
   ...
   */
   ...
   void Update()
   {
      rotationX += Input.GetAxis("RStickX") * cameraSensitivity * Time.deltaTime;
      rotationY += -1.0f * Input.GetAxis("RStickY") * cameraSensitivity * Time.deltaTime;
