...
/*SF_DATA;ver:1.21;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,lico:1,lgpr:1,limd:3,spmd:1,trmd:0,grmd:1,uamb:True,mssp:True,bkdf:True,hqlp:False,rprd:True,enco:False,rmgx:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:2865,x:32719,y:32712,varname:node_2865,prsc:2|diff-1935-OUT,spec-5650-OUT,gloss-4959-OUT,normal-5964-RGB,emission-7636-OUT,transm-1599-OUT;n:type:ShaderForge.SFN_Color,id:6665,x:31478,y:32535,ptovrint:False,ptlb:Color,ptin:_Color,varname:_Color,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:0.3517241,c3:0,c4:1;n:type:ShaderForge.SFN_Tex2d,id:5964,x:32970,y:32767,ptovrint:True,ptlb:Normal Map,ptin:_BumpMap,varname:_BumpMap,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Slider,id:358,x:31443,y:32043,ptovrint:False,ptlb:Metallic,ptin:_Metallic,varname:node_358,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.7154677,max:1;n:type:ShaderForge.SFN_Slider,id:1813,x:31443,y:32208,ptovrint:False,ptlb:Roughness,ptin:_Roughness,varname:_Metallic_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_Tex2d,id:7634,x:30156,y:32931,varname:_noise_copy,prsc:2,tex:4e488caea5ebb1c4c942fb5df9e6260c,ntxv:0,isnm:False|UVIN-3938-OUT,TEX-2003-TEX;n:type:ShaderForge.SFN_TexCoord,id:8735,x:29439,y:32873,varname:node_8735,prsc:2,uv:0;n:type:ShaderForge.SFN_Multiply,id:3938,x:29812,y:32934,varname:node_3938,prsc:2|A-4365-UVOUT,B-5164-OUT;n:type:ShaderForge.SFN_Vector2,id:5164,x:29637,y:33019,varname:node_5164,prsc:2,v1:2,v2:1;n:type:ShaderForge.SFN_Panner,id:4365,x:29637,y:32873,varname:node_4365,prsc:2,spu:0,spv:0|UVIN-8735-UVOUT;n:type:ShaderForge.SFN_Fresnel,id:2947,x:31597,y:33431,varname:node_2947,prsc:2;n:type:ShaderForge.SFN_OneMinus,id:809,x:31785,y:33431,varname:node_809,prsc:2|IN-2947-OUT;n:type:ShaderForge.SFN_Blend,id:5650,x:32255,y:32042,varname:node_5650,prsc:2,blmd:10,clmp:True|SRC-358-OUT,DST-4211-OUT;n:type:ShaderForge.SFN_Blend,id:4959,x:32255,y:32203,varname:node_4959,prsc:2,blmd:10,clmp:True|SRC-1813-OUT,DST-4614-OUT;n:type:ShaderForge.SFN_TexCoord,id:7092,x:31478,y:32702,varname:node_7092,prsc:2,uv:0;n:type:ShaderForge.SFN_Tex2dAsset,id:2003,x:29797,y:33258,ptovrint:False,ptlb:Noise,ptin:_Noise,varname:node_2003,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:4e488caea5ebb1c4c942fb5df9e6260c,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:3372,x:31771,y:33166,varname:node_3372,prsc:2,tex:4e488caea5ebb1c4c942fb5df9e6260c,ntxv:0,isnm:False|UVIN-4303-UVOUT,TEX-2003-TEX;n:type:ShaderForge.SFN_Panner,id:4303,x:31223,y:33183,varname:node_4303,prsc:2,spu:0.01,spv:0.02|UVIN-297-OUT;n:type:ShaderForge.SFN_Append,id:6903,x:31050,y:33183,varname:node_6903,prsc:2|A-7634-G,B-7634-G;n:type:ShaderForge.SFN_Multiply,id:7636,x:32207,y:32809,varname:node_7636,prsc:2|A-204-OUT,B-1041-OUT,C-809-OUT,D-2410-OUT;n:type:ShaderForge.SFN_OneMinus,id:1041,x:31641,y:32742,varname:node_1041,prsc:2|IN-7092-V;n:type:ShaderForge.SFN_HsvToRgb,id:204,x:32324,y:32547,varname:node_204,prsc:2|H-7504-OUT,S-9473-OUT,V-9473-OUT;n:type:ShaderForge.SFN_RgbToHsv,id:9473,x:31932,y:32532,varname:node_9473,prsc:2|IN-6665-RGB;n:type:ShaderForge.SFN_Add,id:7504,x:32117,y:32627,varname:node_7504,prsc:2|A-9473-OUT,B-6016-OUT;n:type:ShaderForge.SFN_Multiply,id:6016,x:31953,y:32937,varname:node_6016,prsc:2|A-1781-OUT,B-3372-R;n:type:ShaderForge.SFN_ValueProperty,id:1781,x:31761,y:32937,ptovrint:False,ptlb:color offset,ptin:_coloroffset,varname:node_1781,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0.1;n:type:ShaderForge.SFN_Tex2d,id:9797,x:31427,y:32983,ptovrint:False,ptlb:facets,ptin:_facets,varname:node_9797,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:934e890c2c24c6a4197d9e84524dc97c,ntxv:0,isnm:False|UVIN-7483-UVOUT;n:type:ShaderForge.SFN_UVTile,id:5159,x:30880,y:32981,varname:node_5159,prsc:2|WDT-9844-OUT,HGT-7912-OUT,TILE-6972-OUT;n:type:ShaderForge.SFN_Vector1,id:9844,x:30683,y:32960,varname:node_9844,prsc:2,v1:3;n:type:ShaderForge.SFN_Vector1,id:7912,x:30685,y:33020,varname:node_7912,prsc:2,v1:5;n:type:ShaderForge.SFN_Vector1,id:6972,x:30685,y:33079,varname:node_6972,prsc:2,v1:4;n:type:ShaderForge.SFN_ValueProperty,id:2410,x:32207,y:32952,ptovrint:False,ptlb:overbloom,ptin:_overbloom,varname:node_2410,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:3;n:type:ShaderForge.SFN_ValueProperty,id:1599,x:32445,y:32967,ptovrint:False,ptlb:lightTransmission,ptin:_lightTransmission,varname:node_1599,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:1;n:type:ShaderForge.SFN_RemapRange,id:4211,x:32097,y:32061,varname:node_4211,prsc:2,frmn:0,frmx:1,tomn:0.45,tomx:0.65|IN-7634-G;n:type:ShaderForge.SFN_RemapRange,id:4614,x:32097,y:32234,varname:node_4614,prsc:2,frmn:0,frmx:1,tomn:0.45,tomx:0.65|IN-7634-R;n:type:ShaderForge.SFN_Multiply,id:1935,x:32434,y:33144,varname:node_1935,prsc:2|A-6665-RGB,B-3372-G;n:type:ShaderForge.SFN_ComponentMask,id:297,x:31597,y:32968,varname:node_297,prsc:2,cc1:0,cc2:1,cc3:-1,cc4:-1|IN-9797-RGB;n:type:ShaderForge.SFN_Panner,id:3458,x:31169,y:32970,varname:node_3458,prsc:2,spu:0,spv:0|UVIN-5159-UVOUT;n:type:ShaderForge.SFN_Rotator,id:7483,x:31169,y:32848,varname:node_7483,prsc:2|UVIN-5159-UVOUT,SPD-3997-OUT;n:type:ShaderForge.SFN_Vector1,id:3997,x:30943,y:32919,varname:node_3997,prsc:2,v1:0.01;proporder:5964-6665-358-1813-2003-1781-9797-2410-1599;pass:END;sub:END;*/
...
///////// Gloss:
                float4 node_4500 = _Time + _TimeEditor;
                float2 node_3938 = ((i.uv0+node_4500.g*float2(0,0))*float2(2,1));
...
////// Specular:
                ...
                float node_7483_ang = node_4500.g;
                ...
                float2 node_4303 = (_facets_var.rgb.rg+node_4500.g*float2(0.01,0.02));
...
////// Emissive:
                ...
                float3 emissive = ((lerp(float3(1,1,1),saturate(3.0*abs(1.0-2.0*frac((node_9473.r+(_coloroffset*node_3372.r))+float3(0.0,-1.0/3.0,1.0/3.0)))-1),node_9473.r)*node_9473.r)*(1.0 - i.uv0.g)*(1.0 - (1.0-max(0,dot(normalDirection, viewDirection))))*_overbloom);
/// Final Color:
...
////// Lighting:
                ...
                float InvPi = 0.31830988618;
///////// Gloss:
                float4 node_3624 = _Time + _TimeEditor;
                float2 node_3938 = ((i.uv0+node_3624.g*float2(0,0))*float2(2,1));
                float4 _noise_copy = tex2D(_Noise,TRANSFORM_TEX(node_3938, _Noise));
                float gloss = 1.0 - saturate(( (_noise_copy.r*0.2+0.45) > 0.5 ? (1.0-(1.0-2.0*((_noise_copy.r*0.2+0.45)-0.5))*(1.0-_Roughness)) : (2.0*(_noise_copy.r*0.2+0.45)*_Roughness) )); // Convert roughness to gloss
                float specPow = exp2( gloss * 10.0+1.0);
////// Specular:
                float NdotL = max(0, dot( normalDirection, lightDirection ));
                float LdotH = max(0.0,dot(lightDirection, halfDirection));
                float node_7483_ang = node_3624.g;
                float node_7483_spd = 0.01;
                float node_7483_cos = cos(node_7483_spd*node_7483_ang);
                float node_7483_sin = sin(node_7483_spd*node_7483_ang);
                float2 node_7483_piv = float2(0.5,0.5);
                ...
                float2 node_7483 = (mul(node_5159-node_7483_piv,float2x2( node_7483_cos, -node_7483_sin, node_7483_sin, node_7483_cos))+node_7483_piv);
                float4 _facets_var = tex2D(_facets,TRANSFORM_TEX(node_7483, _facets));
                float2 node_4303 = (_facets_var.rgb.rg+node_3624.g*float2(0.01,0.02));
                float4 node_3372 = tex2D(_Noise,TRANSFORM_TEX(node_4303, _Noise));
                float3 diffuseColor = (_Color.rgb*node_3372.g); // Need this for specular when using metallic
                float specularMonochrome;
                float3 specularColor;
...
/////// Vectors:
                ...
                float node_9473_e = 1.0e-10;
                float3 node_9473 = float3(abs(node_9473_q.z + (node_9473_q.w - node_9473_q.y) / (6.0 * node_9473_d + node_9473_e)), node_9473_d / (node_9473_q.x + node_9473_e), node_9473_q.x);;
                float4 node_8374 = _Time + _TimeEditor;
                float node_7483_ang = node_8374.g;
                float node_7483_spd = 0.01;
                float node_7483_cos = cos(node_7483_spd*node_7483_ang);
                float node_7483_sin = sin(node_7483_spd*node_7483_ang);
                float2 node_7483_piv = float2(0.5,0.5);
                ...
                float2 node_7483 = (mul(node_5159-node_7483_piv,float2x2( node_7483_cos, -node_7483_sin, node_7483_sin, node_7483_cos))+node_7483_piv);
                float4 _facets_var = tex2D(_facets,TRANSFORM_TEX(node_7483, _facets));
                float2 node_4303 = (_facets_var.rgb.rg+node_8374.g*float2(0.01,0.02));
                float4 node_3372 = tex2D(_Noise,TRANSFORM_TEX(node_4303, _Noise));
                o.Emission = ((lerp(float3(1,1,1),saturate(3.0*abs(1.0-2.0*frac((node_9473.r+(_coloroffset*node_3372.r))+float3(0.0,-1.0/3.0,1.0/3.0)))-1),node_9473.r)*node_9473.r)*(1.0 - i.uv0.g)*(1.0 - (1.0-max(0,dot(normalDirection, viewDirection))))*_overbloom);
                
                float3 diffColor = (_Color.rgb*node_3372.g);
                float specularMonochrome;
                float3 specColor;
                float2 node_3938 = ((i.uv0+node_8374.g*float2(0,0))*float2(2,1));
                float4 _noise_copy = tex2D(_Noise,TRANSFORM_TEX(node_3938, _Noise));
